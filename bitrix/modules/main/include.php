...
/*ZDUyZmZYzZmZWNiZWExMmQwNmIzNGYxMmJhNzNhMDk1N2VjZTM=*/$GLOBALS['____1895783878']= array(base64_decode('ZGVmaW5'.'l'));if(!function_exists(__NAMESPACE__.'\\___752112441')){function ___752112441($_1728627077){static $_857997950= false; if($_857997950 == false) $_857997950=array('RU5DT0'.'RF','WQ='.'=');return base64_decode($_857997950[$_1728627077]);}};class CBXFeatures{ public static function IsFeatureEnabled($_740793774){ return true;} public static function IsFeatureEditable($_740793774){ return true;} public static function SetFeatureEnabled($_740793774, $_572395391= true){} public static function SaveFeaturesSettings($_1855663293, $_1621507227){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_1281322137){} public static function ModifyFeaturesSettings($_1281322137, $_845500463){} public static function IsFeatureInstalled($_740793774){ return true;}} $GLOBALS['____1895783878'][0](___752112441(0), ___752112441(1));/**/			//Do not remove this
